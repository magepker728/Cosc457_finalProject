 ...
 * @author Matthew
 */
public class SalesPerson_Page extends javax.swing.JFrame {

    /**
     * Creates new form SalesPerson_Page
     */
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(SalesPerson_Page.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new SalesPerson_Page().setVisible(true);
            }
        });
    }
