 ...
 * @author Matthew
 */
public class Parts_Page extends javax.swing.JFrame {

    /**
     * Creates new form Parts_Page
     */
    public Parts_Page() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Parts_Page.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Parts_Page().setVisible(true);
            }
        });
    }
